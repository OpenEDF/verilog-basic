...
#3. Create a configuration file to program the device
...
#4. Add memory device to FPGA
create_hw_cfgmem -hw_device [lindex [get_hw_devices $hw_fpga] 0] [lindex [get_cfgmem_parts {mt25ql128-spi-x1_x2_x4}] 0]
...
#5. Select a configuration file and set programming options.
set flash_mscs [list]
