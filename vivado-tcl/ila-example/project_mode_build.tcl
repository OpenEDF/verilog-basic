...
set bit_output_path ./flowled.runs/impl_1/flow_led.bit
...
set_property PROGRAM.FILE $program_files [get_hw_devices $hw_target_fpga]
current_hw_device [get_hw_devices $hw_target_fpga]
refresh_hw_device -update_hw_probes false [lindex [get_hw_devices $hw_target_fpga] 0]

# write the bit file to device
program_hw_devices [get_hw_devices $hw_target_fpga]
refresh_hw_device [lindex [get_hw_devices $hw_target_fpga] 0]
