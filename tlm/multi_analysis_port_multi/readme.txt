Compiler version O-2018.09-SP2_Full64; Runtime version O-2018.09-SP2_Full64;  Oct 23 07:42 2023
...
UVM_INFO component_c.sv(65) @ 0: uvm_test_top.env.comp_c [component_c] inside wirte port a
UVM_INFO component_c.sv(66) @ 0: uvm_test_top.env.comp_c [component_c] recived trans on analysis imp port port
UVM_INFO component_c.sv(67) @ 0: uvm_test_top.env.comp_c [component_c] printing the trans,
 ---------------------------------
Name     Type         Size  Value
---------------------------------
trans    transaction  -     @440
...
UVM_INFO component_c.sv(74) @ 0: uvm_test_top.env.comp_c [component_c] inside wirte port b
UVM_INFO component_c.sv(75) @ 0: uvm_test_top.env.comp_c [component_c] recived trans on analysis imp port port
UVM_INFO component_c.sv(76) @ 0: uvm_test_top.env.comp_c [component_c] printing the trans,
 ---------------------------------
Name     Type         Size  Value
---------------------------------
trans    transaction  -     @440
