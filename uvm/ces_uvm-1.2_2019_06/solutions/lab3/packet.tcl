...
# DVE full session
# Saved on Mon Dec 3 15:11:32 2012
# Designs open: 1
#   V1: vcdplus.vpd
...
# DVE version: G-2012.09-1
# DVE build date: Oct 17 2012 20:54:19


#<Session mode="Full" path="/remote/us01home17/jachang/ces_uvm-1.1_2012.09/labs/lab4/packet.tcl" type="Debug">
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{74 178} {1278 1046}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 141} {height 430} {dock_state left} {dock_on_new_line true} {child_hier_colhier 140} {child_hier_coltype 100} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 207} {height 430} {dock_state left} {dock_on_new_line true} {child_data_colvariable 147} {child_data_colvalue 70} {child_data_coltype 87} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
set Transaction.1 [gui_create_window -type Transaction -parent ${TopLevel.1} -dock_state bottom -dock_on_new_line true -dock_extent 205]
gui_set_window_pref_key -window ${Transaction.1} -key dock_width -value_type integer -value -1
gui_set_window_pref_key -window ${Transaction.1} -key dock_height -value_type integer -value 205
gui_set_window_pref_key -window ${Transaction.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${Transaction.1} {{left 0} {top 0} {width 1204} {height 204} {dock_state bottom} {dock_on_new_line true} {child_transaction_col_expand 16} {child_transaction_col_time 108} {child_transaction_col_message 66} {child_transaction_col_caller 68} {child_transaction_col_name 72} {child_transaction_col_scope 119} {child_transaction_col_severity 56} {child_transaction_col_type 38} {child_transaction_col_relation 57} {child_transaction_col_target 45}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1204} {height 105} {dock_state bottom} {dock_on_new_line true}}
...
gui_show_window -window ${TopLevel.2} -show_state normal -rect {{70 197} {1209 938}}
...
gui_update_layout -id ${Wave.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 331} {child_wave_right 803} {child_wave_colname 163} {child_wave_colvalue 164} {child_wave_col1 0} {child_wave_col2 1}}
...
gui_list_expand -id ${Wave.1} router_test_top.router_if.valido_n
...
gui_view_scroll -id ${Wave.1} -vertical -set 271
