...
# DVE full session
# Saved on Wed Dec 17 16:16:10 2014
# Designs open: 1
#   V1: vcdplus.vpd
...
#<Session mode="Full" path="/remote/us01home17/jachang/ces_uvm-1.2_2014.12/labs/lab3/packet_tr.tcl" type="Debug">
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{81 310} {1534 1171}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 134} {height 266} {dock_state left} {dock_on_new_line true} {child_hier_colhier 140} {child_hier_coltype 100} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 200} {height 266} {dock_state left} {dock_on_new_line true} {child_data_colvariable 147} {child_data_colvalue 70} {child_data_coltype 87} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
set Transaction.1 [gui_create_window -type Transaction -parent ${TopLevel.1} -dock_state bottom -dock_on_new_line true -dock_extent 387]
gui_set_window_pref_key -window ${Transaction.1} -key dock_width -value_type integer -value -1
gui_set_window_pref_key -window ${Transaction.1} -key dock_height -value_type integer -value 387
gui_set_window_pref_key -window ${Transaction.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${Transaction.1} {{left 0} {top 0} {width 1453} {height 386} {dock_state bottom} {dock_on_new_line true} {child_transaction_col_expand 16} {child_transaction_col_time 115} {child_transaction_col_message 245} {child_transaction_col_caller 68} {child_transaction_col_name 49} {child_transaction_col_scope 124} {child_transaction_col_severity 74} {child_transaction_col_type 72} {child_transaction_col_relation 57} {child_transaction_col_target 45}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1453} {height 105} {dock_state bottom} {dock_on_new_line true}}
...
gui_show_window -window ${TopLevel.2} -show_state normal -rect {{379 97} {1511 865}}
...
gui_update_layout -id ${Wave.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 331} {child_wave_right 796} {child_wave_colname 217} {child_wave_colvalue 110} {child_wave_col1 0} {child_wave_col2 1}}
...
gui_list_set_insertion_bar  -id ${Wave.1} -group Group1  -item router_test_top.reset_if.reset_n -position below

gui_marker_move -id ${Wave.1} {C1} 492438
