...
# DVE full session
# Saved on Mon Mar 4 14:29:42 2013
# Designs open: 1
#   V1: vcdplus.vpd
...
#   Wave.1: 11 signals
#   Group count = 2
#   Group router_if signal count = 9
#   Group router_if|reset_if signal count = 2
...
#<Session mode="Full" path="/remote/us01home17/jachang/ces_uvm-1.1_2012.09/labs/lab5/packet.tcl" type="Debug">
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{80 106} {1283 973}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 140} {height 430} {dock_state left} {dock_on_new_line true} {child_hier_colhier 140} {child_hier_coltype 100} {child_hier_col1 0} {child_hier_col2 1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 206} {height 430} {dock_state left} {dock_on_new_line true} {child_data_colvariable 147} {child_data_colvalue 70} {child_data_coltype 87} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_update_layout -id ${Transaction.1} {{left 0} {top 0} {width 1203} {height 203} {dock_state bottom} {dock_on_new_line true} {child_transaction_col_expand 16} {child_transaction_col_time 108} {child_transaction_col_message 66} {child_transaction_col_caller 68} {child_transaction_col_name 72} {child_transaction_col_scope 119} {child_transaction_col_severity 56} {child_transaction_col_type 38} {child_transaction_col_relation 57} {child_transaction_col_target 45}}
...
set router_if router_if
gui_sg_create ${router_if}
gui_sg_addsignal -group ${router_if} { router_test_top.router_if.clk router_test_top.reset_if.reset_n router_test_top.router_if.frame_n router_test_top.router_if.valid_n router_test_top.router_if.din router_test_top.router_if.dout router_test_top.router_if.busy_n router_test_top.router_if.valido_n router_test_top.router_if.frameo_n }
set router_if|reset_if router_if|reset_if
gui_sg_create ${router_if|reset_if}
gui_sg_addsignal -group ${router_if|reset_if} { {router_test_top.reset_if.$unit} router_test_top.reset_if.clk }
...
catch { gui_list_collapse -id ${Transaction.1} {VMM/UVM - msglog} }
catch { gui_list_collapse -id ${Transaction.1} {VMM/UVM - tblog} }
...
gui_open_source -id ${Source.1}  -replace -active router_test_top /remote/us01home17/jachang/ces_uvm-1.1_2012.09/rtl/router_test_top.sv
...
gui_wv_zoom_timerange -id ${Wave.1} 0 32513
gui_list_add_group -id ${Wave.1} -after {New Group} {router_if}
gui_list_add_group -id ${Wave.1} -after {New Group} {router_if|reset_if}
gui_list_select -id ${Wave.1} {router_test_top.reset_if.reset_n }
...
gui_list_set_insertion_bar  -id ${Wave.1} -group router_if  -item router_test_top.reset_if.reset_n -position below

gui_marker_move -id ${Wave.1} {C1} 25887
